...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            logging.info("Raw data saved successfully, initiating train-test-split")
            train_set,test_set = train_test_split(df,test_size=0.2,random_state=42)          
            
            logging.info("Train-test-split done, saving as csv now")
            ...
            logging.info("Train-test-split saved as csv, data ingestion completed")
